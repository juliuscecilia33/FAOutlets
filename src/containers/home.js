    ...
    <Home>
      <Home.Hero>
        <Home.TitleContainer alignItems="flex-start">
          <Home.Title textAlign="left" color="#FFFFFC">
            Select Allergy-
            <br />
            Friendly Foods in an Easy Way.
          </Home.Title>
      ...
      <Home.ManufacturerContainer>
        ...
        <Home.TitleContainer alignItems="flex-end">
          <Home.Title textAlign="right" color="#FFFFFC">
      ...
      <Home.ProductsContainer>
        <Home.TitleContainer alignItems="flex-start">
          <Home.Title textAlign="left" color="#000000">
            Select Products from that Manufacturer.
          </Home.Title>
          <Home.Button to={ROUTES.MANUFACTURERS} background="#EF8354" />
        </Home.TitleContainer>
